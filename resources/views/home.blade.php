    ...
    <div class="modal" data-modal>
        ...
        <div class="modal-content">
            ...
            <div class="newsletter-img">
                <img src="{{ asset('assets/images/newsletter.png') }}" alt="subscribe newsletter" width="400"
                    height="400">
            </div>
        ...
        <div class="header-main">
            ...
            <div class="container">
                ...
                <a href="#" class="header-logo">
                    <img src="{{ asset('assets/images/depopay.png') }}" alt="DepoPay's logo" width="120"
                        height="100">
                </a>
                    ...
                    <li class="menu-category">
                        ...
                        <div class="dropdown-panel">
                            ...
                            <ul class="dropdown-panel-list">
                                ...
                                <li class="panel-list-item">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/mens-banner.jpg') }}" alt="men's fashion"
                            ...
                            <ul class="dropdown-panel-list">
                                ...
                                <li class="panel-list-item">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/electronics-banner-2.jpg') }}"
            ...
            <div class="menu-bottom">
                ...
                <ul class="menu-category-list">
                    ...
                    <li class="menu-category">
                        ...
                        <ul class="submenu-category-list" data-accordion>
                            <li class="submenu-category">
                                <a href="#" class="submenu-title">USD Ugx </a>
                            </li>
                ...
                <div class="category-item-container has-scrollbar">
                    ...
                    <div class="category-item">
                        ...
                        <div class="category-img-box">
                            <img src="{{ asset('assets/images/icons/dress.svg') }}" alt="dress & frock"
                                width="30">
                        </div>
                    ...
                    <div class="category-item">
                        ...
                        <div class="category-img-box">
                            <img src="{{ asset('assets/images/icons/glasses.svg') }}" alt="glasses & lens"
                                width="30">
                        </div>
                    ...
                    <div class="category-item">
                        ...
                        <div class="category-img-box">
                            <img src="{{ asset('assets/images/icons/shorts.svg') }}" alt="shorts & jeans"
                                width="30">
                        </div>
                        ...
                        <ul class="sidebar-menu-category-list">
                            ...
                            <li class="sidebar-menu-category">
                                ...
                                <button class="sidebar-accordion-menu" data-accordion-btn>
                                    ...
                                    <div class="menu-title-flex">
                                        <img src="{{ asset('assets/images/icons/dress.svg') }}" alt="clothes"
                            ...
                            <li class="sidebar-menu-category">
                                ...
                                <button class="sidebar-accordion-menu" data-accordion-btn>
                                    ...
                                    <div class="menu-title-flex">
                                        <img src="{{ asset('assets/images/icons/shoes.svg') }}" alt="footwear"
                            ...
                            <li class="sidebar-menu-category">
                                ...
                                <button class="sidebar-accordion-menu" data-accordion-btn>
                                    ...
                                    <div class="menu-title-flex">
                                        <img src="{{ asset('assets/images/icons/jewelry.svg') }}" alt="clothes"
                                            class="menu-title-img" width="20" height="20">
                            ...
                            <li class="sidebar-menu-category">
                                ...
                                <button class="sidebar-accordion-menu" data-accordion-btn>
                                    ...
                                    <div class="menu-title-flex">
                                        <img src="{{ asset('assets/images/icons/perfume.svg') }}" alt="perfume"
                                            class="menu-title-img" width="20" height="20">
                            ...
                            <li class="sidebar-menu-category">
                                ...
                                <button class="sidebar-accordion-menu" data-accordion-btn>
                                    ...
                                    <div class="menu-title-flex">
                                        <img src="{{ asset('assets/images/icons/cosmetics.svg') }}" alt="cosmetics"
                                            class="menu-title-img" width="20" height="20">
                            ...
                            <li class="sidebar-menu-category">
                                ...
                                <button class="sidebar-accordion-menu" data-accordion-btn>
                                    ...
                                    <div class="menu-title-flex">
                                        <img src="{{ asset('assets/images/icons/glasses.svg') }}" alt="glasses"
                                            class="menu-title-img" width="20" height="20">
                            ...
                            <li class="sidebar-menu-category">
                                ...
                                <button class="sidebar-accordion-menu" data-accordion-btn>
                                    ...
                                    <div class="menu-title-flex">
                                        <img src="{{ asset('assets/images/icons/bag.svg') }}" alt="bags"
                                            class="menu-title-img" width="20" height="20">
                        ...
                        <div class="showcase-wrapper">
                            ...
                            <div class="showcase-container">
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('assets/images/products/3.jpg') }}" alt="girls t-shirt"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('assets/images/products/4.jpg') }}"
                            ...
                            <div class="showcase-wrapper has-scrollbar">
                                ...
                                <div class="showcase-container">
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/clothes-1.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/clothes-2.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/clothes-3.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/shirt-1.jpg') }}"
                                ...
                                <div class="showcase-container">
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/jacket-5.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/jacket-1.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/jacket-3.jpg') }}"
                                                alt="mens winter leathers jackets" class="showcase-img"
                                                width="70">
                                        </a>
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/shorts-1.jpg') }}"
                            ...
                            <div class="showcase-wrapper  has-scrollbar">
                                ...
                                <div class="showcase-container">
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/sports-1.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/sports-2.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/party-wear-1.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/sports-3.jpg') }}"
                                ...
                                <div class="showcase-container">
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/sports-6.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/shoe-3.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/shoe-1.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/shoe-2.jpg') }}"
                            ...
                            <div class="showcase-wrapper  has-scrollbar">
                                ...
                                <div class="showcase-container">
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/watch-3.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/jewellery-3.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/perfume.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/belt.jpg') }}"
                                ...
                                <div class="showcase-container">
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/jewellery-2.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/watch-1.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/shampoo.jpg') }}"
                                    ...
                                    <div class="showcase">
                                        ...
                                        <a href="#" class="showcase-img-box">
                                            <img src="{{ asset('assets/images/products/jewellery-1.jpg') }}"
                        ...
                        <div class="product-grid">
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    ...
                                    <img src="{{ asset('assets/images/products/jacket-4.jpg') }}"
                                        alt="Mens Winter Leathers Jackets" width="300"
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    <img src="{{ asset('assets/images/products/shirt-1.jpg') }}"
                                        ...
                                        width="300">
                                    <img src="{{ asset('assets/images/products/shirt-2.jpg') }}"
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    <img src="{{ asset('assets/images/products/jacket-5.jpg') }}"
                                        ...
                                        width="300">
                                    <img src="{{ asset('assets/images/products/jacket-6.jpg') }}"
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    <img src="{{ asset('assets/images/products/clothes-3.jpg') }}"
                                        ...
                                        width="300">
                                    <img src="{{ asset('assets/images/products/clothes-4.jpg') }}"
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    ...
                                    <img src="{{ asset('assets/images/products/shoe-2_1.jpg') }}"
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    <img src="{{ asset('assets/images/products/watch-3.jpg') }}"
                                        ...
                                        width="300">
                                    <img src="{{ asset('assets/images/products/watch-4.jpg') }}"
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    ...
                                    <img src="{{ asset('assets/images/products/watch-2.jpg') }}"
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    ...
                                    <img src="{{ asset('assets/images/products/party-wear-2.jpg') }}"
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    <img src="{{ asset('assets/images/products/jacket-1.jpg') }}"
                                        ...
                                        width="300">
                                    <img src="{{ asset('assets/images/products/jacket-2.jpg') }}"
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    <img src="{{ asset('assets/images/products/sports-2.jpg') }}"
                                        ...
                                        width="300">
                                    <img src="{{ asset('assets/images/products/sports-4.jpg') }}"
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    <img src="{{ asset('assets/images/products/shoe-1.jpg') }}"
                                        ...
                                        width="300">
                                    <img src="{{ asset('assets/images/products/shoe-1_1.jpg') }}"
                            ...
                            <div class="showcase">
                                ...
                                <div class="showcase-banner">
                                    <img src="{{ asset('assets/images/products/shorts-1.jpg') }}"
                                        ...
                                        width="300">
                                    <img src="{{ asset('assets/images/products/shorts-2.jpg') }}"
          ...
          -->
                    ...
                    <div class="testimonial">
                        ...
                        <div class="testimonial-card">
                            ...
                            <img src="{{ asset('assets/images/testimonial-1.jpg') }}" alt="alan doe"
