...
@section('content')
    <section class="relative w-full h-full py-40 min-h-screen"
        style="background-image: url('{{ asset('assets/images/banner-2.jpg') }}'); background-size: cover; background-position: center;">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="relative w-full mb-3">
                                    ...
                                    <input id="name" name="name" type="text"
                                        class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full {{ $errors->has('name') ? ' ring ring-red-300' : '' }}"
                                        placeholder="{{ __('global.user_name') }}" required autofocus autocomplete="name"
                                        value="{{ old('name') }}" />
                                    @error('name')
